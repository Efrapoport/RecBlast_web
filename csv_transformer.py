...
def gene_list_to_csv(gene_list, taxid, out_file, try_uniprot=True):
    """
    ...
    with open(out_file, "w") as output:
        ...
        for geneDic in genes_data:  # iterating over dicts
            ...
            gene_count += 1  # count gene number
    ...
    if os.stat(out_file).st_size > 30:  # minimum file size because of the header
        ...
        return False  # in web version!


def gene_file_to_csv(infile, tax_id, outfile=None, try_uniprot=True):
    """
